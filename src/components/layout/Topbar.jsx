    ...
    return (
        <header className="h-12 bg-white border-b border-gray-200 flex items-center justify-between px-5 flex-shrink-0">
            ...
            <div className="flex items-center gap-3">
                <span className="text-[10px] text-gray-500 bg-gray-100 border border-gray-200 px-2 py-1 rounded capitalize">{fecha}</span>
                <div className="w-8 h-8 rounded-lg bg-gray-100 border border-gray-200 flex items-center justify-center text-sm cursor-pointer hover:bg-gray-200">🔔</div>
            </div>
        </header>
    )
}